...
public interface BookingService {
    ...
    List<BookingDtoResponse> findByBooker(long userId, String state, int from, int size);

    List<BookingDtoResponse> findByOwner(long userId, String state, int from, int size);
}
